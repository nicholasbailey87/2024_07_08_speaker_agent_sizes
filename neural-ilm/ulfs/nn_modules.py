...
from ulfs import alive_sieve, tensor_utils
...
class DifferentiableDecoder(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_size, rnn_cell=None, e2d_linear=None, d2e_linear=None):
        ...
        self.d2e_linear = nn.Linear(self.vocab_size, self.embedding_size, bias=False) if d2e_linear is None else d2e_linear
...
class StochasticDecoder(nn.Module):
    ...
    def forward(self, x, global_idxes):
        ...
        for t in range(self.utterance_max):
            ...
            s = rl_common.draw_categorical_sample(action_probs=token_probs, batch_idxes=global_idxes[sieve.global_idxes])
