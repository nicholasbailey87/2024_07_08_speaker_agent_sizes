...
class StochasticTrajectory(object):
    def __init__(self, log_g=None, global_idxes=None, actions=None, entropy=None, action_probs=None):
        ...
        if log_g is not None:
            # assert global_idxes is not None
    ...
    def from_stochastic_sample(self, s):
        ...
        # st = StochasticTrajectory(
        #     log_g=s.log_g, global_idxes=global_idxes, actions=s.actions, entropy=s.entropy, action_probs=s.action_probs)
        return st
    ...
    def __add__(self, second):
        ...
        res += second
        return res
        # log_g_l = self.log_g_l + second.log_g_l
        # global_indexes_l = self.global_idxes_l + second.global_idxes_l
        # res.log_g_l = log_g_l
        # res.
