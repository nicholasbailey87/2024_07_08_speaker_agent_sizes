...
class StateCNN(nn.Module):
    def __init__(self, net_string, in_width, in_height, in_channels):
        super().__init__()
        # net_string = net_string.format(embedding_size=output_neurons)  # this is a bit hacky; should standardize to output_neurons
...
class DiscreteSender(nn.Module):
    ...
    def __init__(self, tau, vocab_size, embedding_size, utterance_max):
        ...
        self.decoder = language_model.GumbelDecoder(
            vocab_size=vocab_size, embedding_size=embedding_size, utterance_max=utterance_max, tau=tau, no_terminator=True)
...
class DiscreteReceiver(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_size):
        super().__init__()
        self.encoder = language_model.OnehotEncoder(vocab_size=vocab_size, embedding_size=embedding_size, no_terminator=True)
