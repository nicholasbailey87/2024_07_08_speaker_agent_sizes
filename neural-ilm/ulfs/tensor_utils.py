...
# def pack(X, X_len, Y):
    """
    given X is padded, and X_len is its lengths, but neither are sorted:
    - sort both X and Y, so that X_len is sorted
    - pack these
    - return packed X, and corresponding Y
    """
