"""
this dataset has questions of form:
"is the cube [color]?" (always cube; we vary the color, and whether the label is yes or no)
"""
...
class Dataset(object):
    def __init__(self, data_dir, ds_ref):
        ...
        self.num_classes = 2  # true/false (1/0)
    ...
    def sample(self, batch_size):
        ...
        gnd_color_idxes = self.labels[idxes]
        ...
        question_word_idxes = labels * gnd_color_idxes + (1 - labels) * wrong_color_idxes

        question_texts = []
        for n in range(batch_size):
            question_texts.append(self.colors[question_word_idxes[n]])
