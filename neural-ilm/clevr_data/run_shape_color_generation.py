...
def run(
        ...
        out_dir, b_side, render_num_samples, examples_per_batch, blender_script
    ):
    ...
    start_batch = start_index // examples_per_batch
    ...
    # for idx in range(start_index, start_index + num_examples):
        ...
        run_cmd(
            [
                ...
                '--seed', str(base_seed + start_idx * seed_inc)
            ],
...
if __name__ == '__main__':
    ...
    parser.add_argument('--blender-script', type=str, default='generate_shape_color_examples.py')
