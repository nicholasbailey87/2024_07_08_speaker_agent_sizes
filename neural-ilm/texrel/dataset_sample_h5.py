...
from texrel import dataset_runtime_h5 as dataset_runtime
from texrel.dataset_runtime_h5 import Textured3PlanesDataset
...
def run(ds_refs, sample_holdout, seed, ds_filepath_templ, ds_seed, ds_texture_size, ds_background_noise, ds_mean, ds_mean_std):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ds-filepath-templ', type=str, default='~/data/reftask/{ds_ref}.h5')
